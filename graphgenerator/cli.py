...
@click.option(
    ...
    "--maxresults",
    default = "None",
    help="The maximal number of tweets that we will look at", show_default=True
)
@click.option(
    "-a",
    "--layout_algo",
...
@click.option(
    ...
    "--community_algo",
    default="louvain",
    type=click.Choice(['greedy_modularity', 'asyn_lpa_communities', 'girvan_newman', 'label_propagation', 'louvain']),
